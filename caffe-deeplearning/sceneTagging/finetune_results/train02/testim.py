...
model_def = caffe_root + 'models/finetune_scene/deploy.prototxt'
model_weights = caffe_root + 'models/finetune_scene/snapshots_iter_100000.caffemodel'
...
for line in f:
    ...
    image = caffe.io.load_image(caffe_root + 'data/scene/images/' + im + '.jpg')
    ...
    #print output_prob[281], labels[281]
    #print output_prob[282], labels[282]
